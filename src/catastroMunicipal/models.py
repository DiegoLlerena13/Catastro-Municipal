...
class ZonaUrbana(models.Model):
    zoncod = models.IntegerField(db_column='ZonCod', primary_key=True, verbose_name="Código")
    ...
    zonestreg = models.CharField(db_column='ZonEstReg', max_length=1, verbose_name="Estado de Registro")
